...
public class Job {
    ...
    public Job(int idJob, String nameJob, int J_idJobcate, int J_position, int J_office, String jobDesciption, String jobRequest, String rights, String workplace, String degree, String experience, String applieddate) {
        this.idJob = idJob;
    ...
    public String toString() {
        return "Job{" + "idJob=" + idJob + ", nameJob=" + nameJob + ", J_idJobcate=" + J_idJobcate + ", J_position=" + J_position + ", J_office=" + J_office + ", jobDesciption=" + jobDesciption + ", jobRequest=" + jobRequest + ", rights=" + rights + ", workplace=" + workplace + ", degree=" + degree + ", experience=" + experience + ", applieddate=" + applieddate + '}';
    }
