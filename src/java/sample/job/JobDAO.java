...
public class JobDAO {
    ...
    public List<Job> getListJob() {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new Job(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getInt(4), rs.getInt(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12)));
            }
        } catch (Exception e) {
        }
        return list;
    ...
    public Job getdetailsByIdJob(String idJob) {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                return new Job(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getInt(4), rs.getInt(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12));
            }
        } catch (Exception e) {
        }
        return null;
    ...
    public static void main(String[] args) {
        ...
        List<Job> list = dao.getJobByIdOf("2");
