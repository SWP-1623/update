                                ...
                                <div class="col-lg-9 col-md-9">
                                    <div class="menu-wrapper">
                                        ...
                                        <div class="main-menu">
                                            <nav class="d-none d-lg-block">
                                                <ul id="navigation">
                                                    ...
                                                    <li><a href="/demoSWP/home">Tìm công việc</a>
                                        ...
                                        <div class="header-btn d-none f-right d-lg-block">
                                            <a href="#" class="btn head-btn2">Kết quả ứng tuyển</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Mobile Menu -->
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                                    ...
                                                    <c:forEach items="${of.listOffice}" var="i">
                                                        <li><a id="backa" href="office?idOffice=${i.idOffice}"><p>${i.nameOffice}</p></a></li>
                                                                </c:forEach>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                ...
                                                <div class="card-body">
                                                    <c:forEach items="${jo.listJobcate}" var="y">
                                                        <li><a id="backa" href="category?idJobcate=${y.idJobcate}"><p>${y.nameJobcate}</p></a></li>
                                                                </c:forEach>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <ul>
                                                        <c:forEach items="${po.listPosition}" var="x">
                                                            <li><a id="backa" href="position?idPosition=${x.idPosition}"><p>${x.namePosition}</p></a></li>
                                                                    </c:forEach>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8">
                            ...
                            <section class="featured-job-area">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="count-job mb-35">
                                                <!-- Select job items start -->
                                                <span>Có ${listJ.size()} công việc :</span>
                                    ...
                                    <!-- single-job-content -->
                                    <c:forEach items="${listJ}" var="z" begin="0" end="18">
                            ...
                            <div class="single-wrap d-flex justify-content-center">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-start">
                                        ...
                                        <li class="page-item"><a class="page-link" href="job_listing1.jsp">02</a></li>
                                        <li class="page-item"><a class="page-link" href="job_listing2.jsp">03</a></li>
                                        <li class="page-item"><a class="page-link" href="job_listing3.jsp">04</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
