                                        ...
                                        <div class="main-menu">
                                            <nav class="d-none d-lg-block">
                                                <ul id="navigation">
                                                    ...
                                                    <li><a href="contract.jsp">Kinh nghiệm việc làm</a></li>

                                                    <li><a href="blog.jsp">Hỗ trợ</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                        <!-- Header-btn -->
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            <div class="form-row justify-content-between">
                                                                ...
                                                                <button type="submit" class="btn btn-primary btn-sm ml-1">Tra
                                                                    cứu</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-9 col-md-10">
                                        <div class="hero__caption">
                                            <h1>Có 10.000 việc làm đang chờ bạn</h1>
                                        </div>
                                    </div>
                                </div>
                                <!-- Search Box -->
                                    ...
                                    <div class="col-xl-8">
                                        ...
                                        <form action="#" class="search-box">
                                            <div class="input-form">
                                                <input type="text" placeholder="Bạn muốn tìm việc gì">
                                            </div>
                        ...
                        <div class="row d-flex justify-contnet-center">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="job_listing.jsp">1.Design & Creative</a></h5>
                                        <span>(653)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="job_listing.jsp">2.Design & Development</a></h5>
                                        <span>(658)</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="browse-btn2 text-center mt-50">
                                    <a href="job_listing.jsp" class="border-btn2">Xem tất cả</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="single-testimonial text-center">
                                    ...
                                    <div class="testimonial-caption ">
                                        ...
                                        <div class="testimonial-top-cap">
                                            <p>“Đến với công ty của chúng tôi bạn sẽ được làm ông nội.”</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Single Testimonial -->
